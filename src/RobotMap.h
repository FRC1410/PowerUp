...
const int tank_left_trigger = 2;  //Left trigger (driver)
const int tank_right_trigger = 3; //Right trigger (driver)
...
const int invert_rotator_button = 8;    //Start button (operator)
...
const double default_driver_deadzone = 0.1;
const double default_operator_deadzone = 0.1;
